...
function DocterCard(props) {
    const {name, specialty, hospital, experience, rating, image} = props
  return (
      <>
          <div className='w-[327px] h-[208px] bg-[#FBFCFF] rounded-2xl shadow-sm relative p-4 flex items-center space-x-3'>
              ...
              <img src = {image} alt = "profile" className='w-[100px] h-[90px] rounded-full border mr-[25px] object-cover '/>
